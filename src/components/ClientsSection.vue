...
export default {
  ...
  data() {
    return {
      anpardLogo: anpard,
      bancoMundialLogo: bancoMundial,
      interAmericanBankLogo: interAmericanBank,
      coopsanoLogo: coopsano,
      germanCooperationLogo: germanCooperation,
      infotepLogo: infotep,
      intecLogo: intec,
      isfodosuLogo: isfodosu,
      tropicalLogo: tropical,
